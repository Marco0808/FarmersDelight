...
public class StoveRenderer implements BlockEntityRenderer<StoveBlockEntity>
{
	...
	@Override
	public void render(StoveBlockEntity stoveEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLightIn, int combinedOverlayIn, Vec3 cameraPos) {
