...
public class ModRecipeSerializers
{
	...
	public static final Supplier<RecipeSerializer<FoodServingRecipe>> FOOD_SERVING = RECIPE_SERIALIZERS.register("food_serving", () -> new CustomRecipe.Serializer(FoodServingRecipe::new));
	public static final Supplier<RecipeSerializer<DoughRecipe>> DOUGH = RECIPE_SERIALIZERS.register("dough", () -> new CustomRecipe.Serializer(DoughRecipe::new));
}
