...
public class ModItems
{
	...
	public static Supplier<Item> registerWithTab(final String name, Function<Item.Properties, Item> func, Item.Properties props) {
		Supplier<Item> block = ITEMS.registerItem(name, func, props);
		CREATIVE_TAB_ITEMS.add(block);
		return block;
	}

	public static Supplier<Item> registerWithTab(final String name, Function<Item.Properties, Item> func) {
		return registerWithTab(name, func, new Item.Properties());
	}
	...
	public static final Supplier<Item> FRIED_EGG = registerWithTab("fried_egg",
			(props) -> new Item(props), foodItemProps(FoodValues.FRIED_EGG));
	public static final Supplier<Item> MILK_BOTTLE = registerWithTab("milk_bottle",
			(props) -> new MilkBottleItem(props), drinkItemProps());
	...
	public static final Supplier<Item> TOMATO_SAUCE = registerWithTab("tomato_sauce",
			(props) -> new ConsumableItem(props), foodItemProps(FoodValues.TOMATO_SAUCE).craftRemainder(Items.BOWL));
	public static final Supplier<Item> WHEAT_DOUGH = registerWithTab("wheat_dough",
			(props) -> new Item(props), foodItemProps(FoodValues.WHEAT_DOUGH));
	public static final Supplier<Item> RAW_PASTA = registerWithTab("raw_pasta",
			(props) -> new Item(props), foodItemProps(FoodValues.RAW_PASTA));
	...
	public static final Supplier<Item> PIE_CRUST = registerWithTab("pie_crust",
			(props) -> new Item(props), foodItemProps(FoodValues.PIE_CRUST));
	public static final Supplier<Item> APPLE_PIE = registerWithTab("apple_pie",
			(props) -> new BlockItem(ModBlocks.APPLE_PIE.get(), props));
	public static final Supplier<Item> SWEET_BERRY_CHEESECAKE = registerWithTab("sweet_berry_cheesecake",
			(props) -> new BlockItem(ModBlocks.SWEET_BERRY_CHEESECAKE.get(), props));
