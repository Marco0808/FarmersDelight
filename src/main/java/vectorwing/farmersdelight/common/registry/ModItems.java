...
public class ModItems
{
	...
	public static Item.Properties knifeItem(ToolMaterial toolMaterial) {
		return new Item.Properties().attributes(KnifeItem.createAttributes(toolMaterial, 0.5F, -2.0F));
	}
	...
	public static final Supplier<Item> CUTTING_BOARD = registerWithTab("cutting_board",
			(props) -> new FuelBlockItem(ModBlocks.CUTTING_BOARD.get(), props, 200), basicItem());
	public static final Supplier<Item> BASKET = registerWithTab("basket",
			(props) -> new FuelBlockItem(ModBlocks.BASKET.get(), props, 300), basicItem());
	...
	public static final Supplier<Item> SAFETY_NET = registerWithTab("safety_net",
			(props) -> new FuelBlockItem(ModBlocks.SAFETY_NET.get(), props, 200), basicItem());
	public static final Supplier<Item> OAK_CABINET = registerWithTab("oak_cabinet",
			(props) -> new FuelBlockItem(ModBlocks.OAK_CABINET.get(), props, 300), basicItem());
	public static final Supplier<Item> SPRUCE_CABINET = registerWithTab("spruce_cabinet",
			(props) -> new FuelBlockItem(ModBlocks.SPRUCE_CABINET.get(), props, 300), basicItem());
	public static final Supplier<Item> BIRCH_CABINET = registerWithTab("birch_cabinet",
			(props) -> new FuelBlockItem(ModBlocks.BIRCH_CABINET.get(), props, 300), basicItem());
	public static final Supplier<Item> JUNGLE_CABINET = registerWithTab("jungle_cabinet",
			(props) -> new FuelBlockItem(ModBlocks.JUNGLE_CABINET.get(), props, 300), basicItem());
	public static final Supplier<Item> ACACIA_CABINET = registerWithTab("acacia_cabinet",
			(props) -> new FuelBlockItem(ModBlocks.ACACIA_CABINET.get(), props, 300), basicItem());
	public static final Supplier<Item> DARK_OAK_CABINET = registerWithTab("dark_oak_cabinet",
			(props) -> new FuelBlockItem(ModBlocks.DARK_OAK_CABINET.get(), props, 300), basicItem());
	public static final Supplier<Item> MANGROVE_CABINET = registerWithTab("mangrove_cabinet",
			(props) -> new FuelBlockItem(ModBlocks.MANGROVE_CABINET.get(), props, 300), basicItem());
	public static final Supplier<Item> CHERRY_CABINET = registerWithTab("cherry_cabinet",
			(props) -> new FuelBlockItem(ModBlocks.CHERRY_CABINET.get(), props, 300), basicItem());
	public static final Supplier<Item> BAMBOO_CABINET = registerWithTab("bamboo_cabinet",
			(props) -> new FuelBlockItem(ModBlocks.BAMBOO_CABINET.get(), props, 300), basicItem());
	...
	public static final Supplier<Item> TATAMI = registerWithTab("tatami",
			(props) -> new FuelBlockItem(ModBlocks.TATAMI.get(), props, 400), basicItem());
	public static final Supplier<Item> FULL_TATAMI_MAT = registerWithTab("full_tatami_mat",
			(props) -> new FuelBlockItem(ModBlocks.FULL_TATAMI_MAT.get(), props, 200), basicItem());
	public static final Supplier<Item> HALF_TATAMI_MAT = registerWithTab("half_tatami_mat",
			(props) -> new FuelBlockItem(ModBlocks.HALF_TATAMI_MAT.get(), props), basicItem());
	public static final Supplier<Item> CANVAS_RUG = registerWithTab("canvas_rug",
			(props) -> new FuelBlockItem(ModBlocks.CANVAS_RUG.get(), props, 200), basicItem());
	...
	public static final Supplier<Item> IRON_KNIFE = registerWithTab("iron_knife",
			(props) -> new KnifeItem(ToolMaterial.IRON, props), knifeItem(ToolMaterial.IRON));
	public static final Supplier<Item> DIAMOND_KNIFE = registerWithTab("diamond_knife",
			(props) -> new KnifeItem(ToolMaterial.DIAMOND, props), knifeItem(ToolMaterial.DIAMOND));
	public static final Supplier<Item> NETHERITE_KNIFE = registerWithTab("netherite_knife",
			(props) -> new KnifeItem(ToolMaterial.NETHERITE, props), knifeItem(ToolMaterial.NETHERITE).fireResistant());
	public static final Supplier<Item> GOLDEN_KNIFE = registerWithTab("golden_knife",
			(props) -> new KnifeItem(ToolMaterial.GOLD, props), knifeItem(ToolMaterial.GOLD)));

	public static final Supplier<Item> STRAW = registerWithTab("straw", (props) -> new FuelItem(props), basicItem());
	public static final Supplier<Item> CANVAS = registerWithTab("canvas", (props) -> new FuelItem(props, 400), basicItem());
	public static final Supplier<Item> TREE_BARK = registerWithTab("tree_bark", (props) -> new FuelItem(props, 200), basicItem());
	...
	public static final Supplier<Item> RICE_PANICLE = registerWithTab("rice_panicle", (props) -> new Item(props), basicItem());
	public static final Supplier<Item> RICE = registerWithTab("rice",
			(props) -> new RiceItem(ModBlocks.RICE_CROP.get(), props), basicItem());
	public static final Supplier<Item> CABBAGE_SEEDS = registerWithTab("cabbage_seeds", (props) -> new ItemNameBlockItem(ModBlocks.CABBAGE_CROP.get(), props), basicItem());
	public static final Supplier<Item> TOMATO_SEEDS = registerWithTab("tomato_seeds", (props) -> new ItemNameBlockItem(ModBlocks.BUDDING_TOMATO_CROP.get(), props), basicItem())
	{
		@Override
	...
	public static final Supplier<Item> APPLE_CIDER = registerWithTab("apple_cider",
			(props) -> new DrinkableItem(props, true, false), drinkItem().food(FoodValues.APPLE_CIDER));
	...
	public static final Supplier<Item> FRUIT_SALAD = registerWithTab("fruit_salad",
			(props) -> new ConsumableItem(props, true), bowlFoodItem(FoodValues.FRUIT_SALAD));

	// Basic Meals
	public static final Supplier<Item> MIXED_SALAD = registerWithTab("mixed_salad",
			(props) -> new ConsumableItem(props, true), bowlFoodItem(FoodValues.MIXED_SALAD));
	public static final Supplier<Item> NETHER_SALAD = registerWithTab("nether_salad",
			(props) -> new ConsumableItem(props), bowlFoodItem(FoodValues.NETHER_SALAD));
